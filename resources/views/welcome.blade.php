...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Der inoffizieller Podcast Feed</title>
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <img src="{{asset('/storage/jz-sendung-icon.png')}}" alt="JWConf Sendungen" style="height: 150px">
                        </div>
                    </header>
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <p class="mt-4 text-sm/relaxed">
                                                In deiner Podcast App deiner wahl, fügst diese Url manuel hinzu: (Bei Apple geräte such nach "Sendung per URL hinzufügen ...")
                                            </p>
                                            ...
                                            <div class="gap-4">
                                                <div class="flex">
                                                    <input class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                           id="podcast-url"
                                                           type="text"
                                                           value="{{action([\App\Http\Controllers\FeedController::class, 'feed'])}}" readonly
                                    ...
                                    <button type="button" class="inset-y-0 right-0 items-center px-3" onclick="copyToClipboard()">
                                        <svg class="size-5 sm:size-6" fill="#FF2D20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
{{--                        Private by Tobi Matthaiou--}}
        ...
        <style>
            .colorGreen {
                background: linear-gradient(to right bottom, #4fb000, #96c93d)
            }
            .colorRed {
                background: linear-gradient(to top, #b00000, #c93d3d)
            }
        </style>
        <script>
            function copyToClipboard() {
                ...
                navigator.clipboard.writeText(copyText.value).then(function() {
                    ToastAnimation('Text erfolgreich in Zwischenablage kopiert!');
                }).catch(function(error) {
                    ToastAnimation('Fehler beim Kopieren des Textes: ', error);
                });
            }

            function ToastAnimation(message, error) {
